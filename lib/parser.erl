...
yeccpars2_cont_2(S, escape, Ss, Stack, T, Ts, Tzr) ->
...
yeccpars2_3(S, escape, Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 12, Ss, Stack, T, Ts, Tzr);
...
yeccgoto_elem(18, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_8(8, Cat, Ss, Stack, T, Ts, Tzr).
...
yeccgoto_range(2=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_5(_S, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_range(10=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_5(_S, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_range(18=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_5(_S, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_set/7}).
yeccgoto_set(2=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_4(_S, Cat, Ss, Stack, T, Ts, Tzr);
...
-file("lib/grammar/parser.yrl", 23).
...
-file("lib/grammar/parser.yrl", 20).
...
-file("lib/grammar/parser.yrl", 17).
...
-file("lib/grammar/parser.yrl", 21).
...
-file("lib/grammar/parser.yrl", 18).
